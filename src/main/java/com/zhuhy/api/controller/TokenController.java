...
import com.zhuhy.api.entity.AccessToken;
import com.zhuhy.api.entity.ApiResponse;
import com.zhuhy.api.entity.AppInfo;
import com.zhuhy.api.entity.TokenInfo;
import com.zhuhy.api.entity.UserInfo;
...
public class TokenController {
	...
	public ApiResponse<AccessToken> apiToken(String appId,
		...
		Assert.isTrue(
				!StringUtils.isEmpty(appId) && !StringUtils.isEmpty(timestamp)
	...
	public ApiResponse<UserInfo> userToken(String username, String password) {
		...
		UserInfo userInfo = new UserInfo(username,
				"81255cb0dca1a5f304328a70ac85dcbd", "111111");
	...
	private AccessToken saveToken(int tokenType, AppInfo appInfo,
		...
		// 4. 保存token
		ValueOperations<String, TokenInfo> operations = redisTemplate
				.opsForValue();
	...
	public static void main(String[] args) {
		...
		signString = "password=123456&username=1&12345678954556"
				+ "ff03e64b-427b-45a7-b78b-47d9e8597d3b1529815393153sdfsdfsfs"
				+ timestamp + "A1scr6";
